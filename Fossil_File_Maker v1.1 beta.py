...
class VIEW3D_OT_SubmitContactPointOperator1(Operator):
    ...
    def execute(self, context):
        ...
        if vertices:
            # Guardar las coordenadas del primer punto seleccionado
            ...
            # Expandir la selección y guardar las coordenadas de todos los vértices seleccionados
            set_object_mode(context.active_object, 'EDIT')
