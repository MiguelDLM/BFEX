---
title: BFEX - Blender FEA Exporter
description: BFEX is an add-on designed to facilitate the creation of files required for Finite Element Analysis (FEA) within Blender.
format: pdf
...
![Mesh with good quality example](Quality%20of%20the%20mesh%20example.png)
